...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', 'gbb', function() gotoBreakpoint('next') end, { desc = 'Next breakpoint' })
    vim.keymap.set('n', 'gbB', function() gotoBreakpoint('prev') end, { desc = 'Previous breakpoint' })
  end,
}

...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>shf', function() builtin.find_files { hidden = true } end, { desc = '[S]earch [H]idden [F]iles' })
      vim.keymap.set('n', '<leader>shg', function() builtin.live_grep { additional_args = { '--hidden' } } end, { desc = '[S]earch [H]idden by [G]rep' })
      ...
      local servers = {
        ...
        basedpyright = {
          on_init = function(client)
            ...
            local python_path = require('kickstart.venv').get_python_path(venv)
            if python_path then
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        -- Disable format-on-save for these file types (e.g. no auto-format for Python)
